<!-- One widget per pull request. See CONTRIBUTING.md. -->

**What it shows:**

**Where its content comes from** (every host in `contacts`, and what each is used for — fetch, image or link):
...
- [ ] It is my own work, or I have the right to publish it here under the MIT license, and any content it shows is used within its source's terms
